...
public class PlayerController : MonoBehaviourPunCallbacks
{
    ...
    public void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        // State °´Ã¼´Â ÄÃ¶óÀÌ´õ¸¦ °¡Áö°í ÀÖÁö¾Ê¾Æ¼­ OnTriggerEnter2D°¡ ÀÛµ¿ÇÏÁö¾Ê½À´Ï´Ù.
        // Á¦°¡º¸±â¿£ ÀÌ Ãæµ¹Ã¼Å©´Â ¹®¿¡¼­ Ã³¸®ÇØ¾ßÇÒ°Å°°¾Æ¿ä : Class Door

        // ¹®¿¡¼­ Ãæµ¹Ã¼Å©¸¦ÇÏ¸é collision.gameObject.Getcomponent<PlayerController>().nextStage = this.gameobject; 
        Debug.Log("ÄÝ¸®Á¯Ã¼Å©½Ãµµ ");
