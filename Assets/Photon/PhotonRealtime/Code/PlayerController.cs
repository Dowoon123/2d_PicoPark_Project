...
namespace Photon.Realtime
{
    ...
    public class PlayerController
    {
        ...
        protected internal PlayerController(string nickName, int actorNumber, bool isLocal) : this(nickName, actorNumber, isLocal, null)
        {
        }
        ...
        protected internal PlayerController(string nickName, int actorNumber, bool isLocal, Hashtable playerProperties)
        {
        ...
        public PlayerController Get(int id)
        {
            if (this.RoomReference == null)
            {
                return null;
        ...
        /// <returns>Player or null.</returns>
        public PlayerController GetNextFor(PlayerController currentPlayer)
        {
        ...
        /// <returns>Player or null.</returns>
        public PlayerController GetNextFor(int currentPlayerId)
        {
            ...
            Dictionary<int, PlayerController> players = this.RoomReference.Players;
        ...
        {
            PlayerController pp = p as PlayerController;
