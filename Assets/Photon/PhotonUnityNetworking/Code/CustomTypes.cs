...
namespace Photon.Pun
{
    ...
    internal static class CustomTypes
    {
        ...
        {
            PhotonPeer.RegisterType(typeof(PlayerController), (byte) 'P', SerializePhotonPlayer, DeserializePhotonPlayer);
        }
        ...
        {
            int ID = ((PlayerController) customobject).ActorNumber;
        ...
        private static object DeserializePhotonPlayer(StreamBuffer inStream, short length)
        {
            ...
            {
                PlayerController player = PhotonNetwork.CurrentRoom.GetPlayer(ID);
                return player;
            }
            return null;
        }
