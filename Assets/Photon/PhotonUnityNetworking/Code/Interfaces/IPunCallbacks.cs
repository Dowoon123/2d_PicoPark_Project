...
namespace Photon.Pun
{
    ...
    public interface IPunOwnershipCallbacks
    {
        ...
        void OnOwnershipRequest(PhotonView targetView, PlayerController requestingPlayer);
        ...
        void OnOwnershipTransfered(PhotonView targetView, PlayerController previousOwner);
        ...
        void OnOwnershipTransferFailed(PhotonView targetView, PlayerController senderOfFailedRequest);
    }
