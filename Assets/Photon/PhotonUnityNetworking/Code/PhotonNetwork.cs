...
namespace Photon.Pun
{
    ...
    public struct InstantiateParameters
    {
        ...
        public InstantiateParameters(string prefabName, Vector3 position, Quaternion rotation, byte @group, object[] data, byte objLevelPrefix, int[] viewIDs, PlayerController creator, int timestamp)
        {
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// </summary>
        public static PlayerController[] PlayerList
        {
            get
            {
        ...
        /// </summary>
        public static PlayerController[] PlayerListOthers
        {
            get
            {
                Room room = CurrentRoom;
        ...
        /// </remarks>
        public static PlayerController MasterClient
        {
            get
            {
                if (OfflineMode)
        ...
        public static bool CloseConnection(PlayerController kickPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return false;
        ...
        public static bool SetMasterClient(PlayerController masterClientPlayer)
        {
        ...
        private static GameObject NetworkInstantiate(Hashtable networkEvent, PlayerController creator)
        {
        ...
        /// </remarks>
        /// <returns>Nothing. Check error debug log for any issues.</returns>
        public static void DestroyPlayerObjects(PlayerController targetPlayer)
        {
        ...
        public static void RemoveRPCs(PlayerController targetPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
        ...
        /// Internal to send an RPC on given PhotonView. Do not call this directly but use: PhotonView.RPC!
        /// </summary>
        internal static void RPC(PhotonView view, string methodName, PlayerController targetPlayer, bool encrypt, params object[] parameters)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
