    ...
    public class PhotonView : MonoBehaviour
    {
        ...
        public int OwnerActorNr
        {
            ...
            set
            {
                ...
                PlayerController prevOwner = this.Owner;
        ...
        public int ControllerActorNr
        {
            ...
            set
            {
                PlayerController prevController = this.Controller;
        ...
        /// The owner/controller of a PhotonView is also the client which sends position updates of the GameObject.
        /// </remarks>
        public void TransferOwnership(PlayerController newOwner)
        {
            if (newOwner != null)
        ...
        /// <param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
        public void RPC(string methodName, PlayerController targetPlayer, params object[] parameters)
        {
        ...
        ///<param name="encrypt"> </param>
        ///<param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
        public void RpcSecure(string methodName, PlayerController targetPlayer, bool encrypt, params object[] parameters)
        {
