...
namespace Photon.Pun
{
    ...
    public class MonoBehaviourPunCallbacks : MonoBehaviourPun, IConnectionCallbacks , IMatchmakingCallbacks , IInRoomCallbacks, ILobbyCallbacks, IWebRpcCallback, IErrorInfoCallback
    {
        ...
        /// </remarks>
        public virtual void OnMasterClientSwitched(PlayerController newMasterClient)
        {
        }
        ...
        /// </remarks>
        public virtual void OnPlayerEnteredRoom(PlayerController newPlayer)
        {
        }
        ...
        /// </remarks>
        public virtual void OnPlayerLeftRoom(PlayerController otherPlayer)
        {
        }
        ...
        public virtual void OnPlayerPropertiesUpdate(PlayerController targetPlayer, Hashtable changedProps)
        {
        }
    ...
    public struct PhotonMessageInfo
    {
        ...
        public PhotonMessageInfo(PlayerController player, int timestamp, PhotonView view)
        {
            this.Sender = player;
    ...
    public class PhotonStream
    {
        ...
        /// Will read or write the value, depending on the stream's IsWriting value.
        /// </summary>
        public void Serialize(ref PlayerController obj)
        {
            if (this.IsWriting)
            {
                this.writeData.Add(obj);
            ...
            else
            {
                if (this.readData.Length > this.currentItem)
                {
                    obj = (PlayerController) this.readData[this.currentItem];
                    this.currentItem++;
                }
            }
        }
