...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PhotonTeamsManager : MonoBehaviour, IMatchmakingCallbacks, IInRoomCallbacks
    {
        ...
        private Dictionary<byte, HashSet<PlayerController>> playersPerTeam;
        ...
        public static event Action<PlayerController, PhotonTeam> PlayerJoinedTeam;
        public static event Action<PlayerController, PhotonTeam> PlayerLeftTeam;
        ...
        private void Init()
        {
            ...
            playersPerTeam = new Dictionary<byte, HashSet<PlayerController>>(teamsList.Count);
            for (int i = 0; i < teamsList.Count; i++)
            {
                teamsByCode[teamsList[i].Code] = teamsList[i];
                teamsByName[teamsList[i].Name] = teamsList[i];
                playersPerTeam[teamsList[i].Code] = new HashSet<PlayerController>();
            }
        }
        ...
        void IInRoomCallbacks.OnPlayerPropertiesUpdate(PlayerController targetPlayer, Hashtable changedProps)
        {
            object temp;
        ...
        void IInRoomCallbacks.OnPlayerLeftRoom(PlayerController otherPlayer)
        {
        ...
        void IInRoomCallbacks.OnPlayerEnteredRoom(PlayerController newPlayer)
        {
        ...
        private void UpdateTeams()
        {
            ...
            {
                PlayerController player = PhotonNetwork.PlayerList[i];
        ...
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(byte code, out PlayerController[] members)
        {
            members = null;
            HashSet<PlayerController> players;
            if (this.playersPerTeam.TryGetValue(code, out players))
            {
                members = new PlayerController[players.Count];
                int i = 0;
        ...
        /// <param name="members">The array of players to be filled.</param>
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(string teamName, out PlayerController[] members)
        {
            members = null;
            PhotonTeam team;
        ...
        /// <param name="members">The array of players to be filled.</param>
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMembers(PhotonTeam team, out PlayerController[] members)
        {
            members = null;
            if (team != null)
            {
        ...
        /// <returns>If successful or not.</returns>
        public bool TryGetTeamMatesOfPlayer(PlayerController player, out PlayerController[] teamMates)
        {
            teamMates = null;
            if (player == null)
            {
            ...
            if (this.playersPerTeam.TryGetValue(team.Code, out players))
            {
                ...
                teamMates = new PlayerController[players.Count - 1];
                int i = 0;
        ...
        void IInRoomCallbacks.OnMasterClientSwitched(PlayerController newMasterClient)
        {
        }
    ...
    public static class PhotonTeamExtensions
    {
        ...
        public static PhotonTeam GetPhotonTeam(this PlayerController player)
        {
            object teamId;
            PhotonTeam team;
        ...
        /// <returns></returns>
        public static bool JoinTeam(this PlayerController player, PhotonTeam team)
        {
            if (team == null)
            {
        ...
        /// <returns></returns>
        public static bool JoinTeam(this PlayerController player, byte teamCode)
        {
            PhotonTeam team;
        ...
        /// <returns></returns>
        public static bool JoinTeam(this PlayerController player, string teamName)
        {
            PhotonTeam team;
        ...
        public static bool SwitchTeam(this PlayerController player, PhotonTeam team)
        {
            if (team == null)
            {
        ...
        public static bool SwitchTeam(this PlayerController player, byte teamCode)
        {
            PhotonTeam team;
        ...
        /// <returns>If the team switch request is queued to be sent to the server or done in case offline or not joined to a room yet.</returns>
        public static bool SwitchTeam(this PlayerController player, string teamName)
        {
            PhotonTeam team;
        ...
        public static bool LeaveCurrentTeam(this PlayerController player)
        {
            PhotonTeam currentTeam = player.GetPhotonTeam();
            if (currentTeam == null)
            {
        ...
        /// <returns>If successful or not.</returns>
        public static bool TryGetTeamMates(this PlayerController player, out PlayerController[] teamMates)
        {
