...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PlayerNumbering : MonoBehaviourPunCallbacks
    {
        ...
        public static PlayerController[] SortedPlayers;
       ...
       public void RefreshData()
        {
            ...
            PlayerController[] sorted = PhotonNetwork.PlayerList.OrderBy((p) => p.ActorNumber).ToArray();

            string allPlayers = "all players: ";
            foreach (PlayerController player in sorted)
            {
    ...
    public static class PlayerNumberingExtensions
    {
        ...
        public static int GetPlayerNumber(this PlayerController player)
        {
			if (player == null) {
				return -1;
			}
        ...
        public static void SetPlayerNumber(this PlayerController player, int playerNumber)
        {
			if (player == null) {
				return;
			}
