...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        public static void SetScore(this PlayerController player, int newScore)
        {
        ...
        public static void AddScore(this PlayerController player, int scoreToAddToCurrent)
        {
        ...
        public static int GetScore(this PlayerController player)
        {
            object score;
