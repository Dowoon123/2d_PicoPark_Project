...
namespace Photon.Pun.UtilityScripts
{
    ...
    public class PunTeams : MonoBehaviourPunCallbacks
    {
        ...
        public static Dictionary<Team, List<PlayerController>> PlayersPerTeam;
        ...
        public void Start()
        {
            PlayersPerTeam = new Dictionary<Team, List<PlayerController>>();
            Array enumVals = Enum.GetValues(typeof(Team));
            foreach (var enumVal in enumVals)
            {
                PlayersPerTeam[(Team)enumVal] = new List<PlayerController>();
            }
        }
    ...
    public static class TeamExtensions
    {
        ...
        public static PunTeams.Team GetTeam(this PlayerController player)
        {
            object teamId;
        ...
        public static void SetTeam(this PlayerController player, PunTeams.Team team)
        {
