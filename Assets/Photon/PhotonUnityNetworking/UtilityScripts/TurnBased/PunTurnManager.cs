...
namespace Photon.Pun.UtilityScripts
{
	...
	public class PunTurnManager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        /// </summary>
        private readonly HashSet<PlayerController> finishedPlayers = new HashSet<PlayerController>();
        ...
        public bool GetPlayerFinishedTurn(PlayerController player)
        {
    ...
    public interface IPunTurnManagerCallbacks
    {
        ...
        void OnPlayerMove(PlayerController player, int turn, object move);
        ...
        /// <param name="turn">Turn index</param>
        /// <param name="move">Move Object data</param>
        void OnPlayerFinished(PlayerController player, int turn, object move);
    ...
    public static class TurnExtensions
    {
        ...
        /// <param name="player">Player reference</param>
        public static int GetFinishedTurn(this PlayerController player)
        {
        ...
        /// <param name="player">Player Reference</param>
        /// <param name="turn">Turn Index</param>
        public static void SetFinishedTurn(this PlayerController player, int turn)
        {
            Room room = PhotonNetwork.CurrentRoom;
            if (room == null || room.CustomProperties == null)
            {
